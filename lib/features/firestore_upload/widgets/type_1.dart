...
class Type1Screen extends StatefulWidget {
  const Type1Screen({super.key});

  @override
  State<Type1Screen> createState() => _Type1ScreenState();
}

class _Type1ScreenState extends State<Type1Screen> {
